...
The British Parliamentary debate organizing authorities and the culture that they themselves and their participants have upheld voluntarily imposes expectations, norms, and customs, on the adjudicator. These norms are toothless in force, as violating them solicits no punishment - noncompliance solicits at best only embarassment, humiliation, or bin-room adjudication duties. 
    ...
    % Obviously, it's going to be difficult to really introduce the full range of stakes commensurate to the impact of the kind of speech made by champagne socialists at world finals. It's not possible to expose debaters to the full consequences of their arguments. They can argue for "This House Would impose a 100\% inheritance tax" and then go on vacation in Ibiza on their trust fund.
...
\item \textbf{the disinvestment of one's soul from the argument. }
...
\item \textbf{Unchecked mindless intellectual outgrowth.} The ultimate cumulative effective of this kind of pressure over many, many rounds of debate, over many, many tournaments, inflicted on class after class of young adults, is mass intellectual drift with no real input or pushback. A mass of mindless evolutionary outgrowth mushrooms into existence. 
